...
public extension XCTestCase {
  ...
  ///
  /// Currently, this is hardcoded to logical width and height of iPhone 15 Pro Max screen. It
  /// assumes that tests are ran only on iPhone 15 Pro Max simulator, so you’ll need to change this
  /// also in the Xcode Cloud workflow. Change the device from “recommended iPhones” to
  /// “iPhone 15 Pro Max”.
  ///
  /// - Parameters:
